 ...
 * @author ermex
 */
public class tablaImgNotas implements Serializable{
    private Integer satelite;
    private String jk;
    private String fecha;
    private String nivelProce;
    private String copia;
        public  tablaImgNotas()
        {

        }
        public  tablaImgNotas(Integer satelite, String jk, String fecha, String nivelPro, String copia)
        {
            this.copia=copia;
            this.jk=jk;
            this.fecha=fecha;
